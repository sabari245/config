...
-- - Inside tmux, prefer Neovim's tmux provider. It integrates with tmux's
--   buffer/clipboard flow and avoids OSC 52 paste timeouts.
-- - Over SSH outside tmux, use OSC 52 as a copy-friendly fallback.
